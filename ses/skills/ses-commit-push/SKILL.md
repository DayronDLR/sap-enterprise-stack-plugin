---
name: ses-commit-push
description: Analiza los cambios pendientes, arma commits coherentes y los publica.
---
...
> stack se invocan como skills, con `$ses-commit-push`.
...
4. **Reporte de uso del agente**: Si se completó una tarea en esta sesión y aún no existe el reporte de cierre, generarlo en `docs/claude-reports/YYYY-MM-DD_<slug>.md` siguiendo la plantilla de `rules/TASK-COMPLETION-REPORT.md`.
