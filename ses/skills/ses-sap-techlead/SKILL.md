...
1. Resolvé el motor SDD con el bloque de `.agents/skills/sap-sdd/SKILL.md`
...
- `.agents/orchestrator/routing_rules.json` — reglas de enrutamiento, dependencias y desambiguación
- `.agents/shared/core-dev-principles.md` — principios de desarrollo que aplican a todos los agentes
...
- **Si no existe**: crearlo con la estructura de `.agents/shared/context-tracking.md`.
