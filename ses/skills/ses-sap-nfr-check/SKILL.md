...
> stack se invocan como skills, con `$ses-sap-nfr-check`.
...
1. Lee `.agents/shared/non-functional-requirements.md` y `.agents/agents/09-qa-testing/nfr-checklist.md`
