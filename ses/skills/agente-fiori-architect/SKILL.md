...
- `mcp__sap_ui5__get_version_info` — versión SAPUI5 en uso
- `mcp__sap_fiori_tools__search_docs` — documentación Fiori Elements / floorplans
- `mcp__sap_fiori_tools__list_fiori_apps` — apps existentes para evitar duplicados
- `mcp__sap_ui5__get_api_reference` — cuando el diseño dependa de controles específicos
