...
> stack se invocan como skills, con `$ses-sap-abap`.
...
Lee el archivo `.agents/agents/06-abap-developer/system_prompt.md` y adopta completamente esa perspectiva de ABAP Developer Senior para el resto de esta conversación.
