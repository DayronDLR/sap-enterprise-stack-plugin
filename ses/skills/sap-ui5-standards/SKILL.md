...
- **Sin APIs deprecadas** — validá con `mcp__sap_ui5__get_api_reference` ante la duda.
...
```bash
ui5lint                      # o mcp__sap_ui5__run_ui5_linter
```

Y `mcp__sap_ui5__run_manifest_validation` si tocaste `manifest.json`.
