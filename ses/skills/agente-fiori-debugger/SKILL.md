...
- `mcp__sap_ui5__get_api_reference` — si el error es de API UI5
- `mcp__sap_fiori_tools__search_docs` — si el error es de annotations o Fiori Elements
- `mcp__sap_ui5__run_ui5_linter` — ejecutar sobre el archivo con error
- `mcp__sap_ui5__run_manifest_validation` — si el error involucra manifest
...
1. `mcp__sap_ui5__run_ui5_linter` — verificar que el fix no introduce nuevos errores
