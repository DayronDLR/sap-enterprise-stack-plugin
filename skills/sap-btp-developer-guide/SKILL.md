...
- **CAP development patterns**: `sap-cap-capire` skill (canonical for CDS, services, handlers, Node.js/Java)
- **Deployment to CF/Kyma**: `sap-btp-best-practices` skill (canonical for deployment-and-delivery)
- **Authentication & OAuth**: `sap-btp-connectivity` skill (canonical for destinations, auth types, principal propagation)
- **ABAP CDS views**: `sap-abap-cds` skill (canonical for ABAP CDS annotations, DCL, access control)
