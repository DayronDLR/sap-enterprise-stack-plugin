...
- **CAP integration with HANA**: `sap-cap-capire` skill (canonical for CDS models, HDI deployment)
- **BTP deployment**: `sap-btp-best-practices` skill (canonical for CF/Kyma deployment patterns)
- **ABAP AMDP**: `sap-abap` skill (canonical for AMDP class implementation in ABAP)
