...
Leé `.agents/skills/sap-sdd/SKILL.md`: tiene el protocolo de cierre de fase,
...
|---|---|
| C1 Captura | `.agents/skills/sap-sdd/reference/C1-captura.md` |
| C2 Escenarios | `.agents/skills/sap-sdd/reference/C2-escenarios.md` |
| C3 Diseño | `.agents/skills/sap-sdd/reference/C3-diseno.md` |
| C4 Plan y estimación | `.agents/skills/sap-sdd/reference/C4-plan.md` |
