---
name: ses-sap-basis
description: Roles y autorizaciones, transportes, landscape, segregacion de funciones y GRC.
---
...
> stack se invocan como skills, con `$ses-sap-basis`.
...
Lee el archivo `.agents/agents/07-basis-security/system_prompt.md` y adopta completamente esa perspectiva de SAP Basis & Security Architect para el resto de esta conversación.

Luego atiende la siguiente solicitud:
