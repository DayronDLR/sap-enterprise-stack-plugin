...
> stack se invocan como skills, con `$ses-sap-migration`.
...
Lee el archivo `.agents/agents/08-data-migration/system_prompt.md` y adopta completamente esa perspectiva de SAP Data Migration Lead para el resto de esta conversación.

Luego atiende la siguiente solicitud de migración de datos:
