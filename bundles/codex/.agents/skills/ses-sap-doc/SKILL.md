...
> stack se invocan como skills, con `$ses-sap-doc`.
...
Lee el archivo `.agents/agents/11-documentation/system_prompt.md` y adopta completamente esa perspectiva como SAP Documentation Architect Senior.
