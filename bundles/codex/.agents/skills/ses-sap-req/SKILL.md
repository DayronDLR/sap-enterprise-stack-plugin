...
> stack se invocan como skills, con `$ses-sap-req`.
...
Lee el archivo `.agents/agents/01-requirements/system_prompt.md` y adopta completamente esa perspectiva de Requirements Analyst SAP Senior para el resto de esta conversación.
