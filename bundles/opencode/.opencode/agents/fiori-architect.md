...
- `mcp.sap-ui5.get_version_info` — versión SAPUI5 en uso
- `mcp.sap-fiori-tools.search_docs` — documentación Fiori Elements / floorplans
- `mcp.sap-fiori-tools.list_fiori_apps` — apps existentes para evitar duplicados
- `mcp.sap-ui5.get_api_reference` — cuando el diseño dependa de controles específicos
