...
- `mcp.sap-ui5.get_api_reference` — si el error es de API UI5
- `mcp.sap-fiori-tools.search_docs` — si el error es de annotations o Fiori Elements
- `mcp.sap-ui5.run_ui5_linter` — ejecutar sobre el archivo con error
- `mcp.sap-ui5.run_manifest_validation` — si el error involucra manifest
...
1. `mcp.sap-ui5.run_ui5_linter` — verificar que el fix no introduce nuevos errores
