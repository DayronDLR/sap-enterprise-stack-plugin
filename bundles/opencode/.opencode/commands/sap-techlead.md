...
- `.opencode/orchestrator/routing_rules.json` — reglas de enrutamiento, dependencias y desambiguación
- `.opencode/shared/core-dev-principles.md` — principios de desarrollo que aplican a todos los agentes
...
```text
.opencode/agents/{NN-nombre}/system_prompt.md   ← SOLO los agentes que aplican a esta tarea
```
...
- **Si no existe**: crearlo con la estructura de `.opencode/shared/context-tracking.md`.
