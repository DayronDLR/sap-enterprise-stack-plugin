...
Lee el archivo `.opencode/agents/07-basis-security/system_prompt.md` y adopta completamente esa perspectiva de SAP Basis & Security Architect para el resto de esta conversación.
