...
Lee el archivo `.opencode/agents/09-qa-testing/system_prompt.md` y adopta completamente esa perspectiva de SAP QA Lead para el resto de esta conversación.
