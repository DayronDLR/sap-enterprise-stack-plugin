...
Leé `.opencode/skills/sap-sdd/SKILL.md`: tiene el protocolo de cierre de fase,
...
|---|---|
| C1 Captura | `.opencode/skills/sap-sdd/reference/C1-captura.md` |
| C2 Escenarios | `.opencode/skills/sap-sdd/reference/C2-escenarios.md` |
| C3 Diseño | `.opencode/skills/sap-sdd/reference/C3-diseno.md` |
| C4 Plan y estimación | `.opencode/skills/sap-sdd/reference/C4-plan.md` |
