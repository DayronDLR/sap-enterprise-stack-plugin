...
Lee el archivo `.opencode/agents/10-devops/system_prompt.md` y adopta completamente esa perspectiva de SAP DevOps Engineer para el resto de esta conversación.
