...
- **Sin APIs deprecadas** — validá con `mcp.sap-ui5.get_api_reference` ante la duda.
...
```bash
ui5lint                      # o mcp.sap-ui5.run_ui5_linter
```

Y `mcp.sap-ui5.run_manifest_validation` si tocaste `manifest.json`.
