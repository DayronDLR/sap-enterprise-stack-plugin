...
- **Sin APIs deprecadas** — validá con `mcp_sap_ui5_get_api_reference` ante la duda.
...
```bash
ui5lint                      # o mcp_sap_ui5_run_ui5_linter
```

Y `mcp_sap_ui5_run_manifest_validation` si tocaste `manifest.json`.
