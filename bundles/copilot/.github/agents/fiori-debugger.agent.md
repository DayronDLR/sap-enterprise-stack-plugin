...
- `mcp_sap_ui5_get_api_reference` — si el error es de API UI5
- `mcp_sap_fiori_tools_search_docs` — si el error es de annotations o Fiori Elements
- `mcp_sap_ui5_run_ui5_linter` — ejecutar sobre el archivo con error
- `mcp_sap_ui5_run_manifest_validation` — si el error involucra manifest
...
1. `mcp_sap_ui5_run_ui5_linter` — verificar que el fix no introduce nuevos errores
