...
- `mcp_sap_ui5_get_version_info` — versión SAPUI5 en uso
- `mcp_sap_fiori_tools_search_docs` — documentación Fiori Elements / floorplans
- `mcp_sap_fiori_tools_list_fiori_apps` — apps existentes para evitar duplicados
- `mcp_sap_ui5_get_api_reference` — cuando el diseño dependa de controles específicos
