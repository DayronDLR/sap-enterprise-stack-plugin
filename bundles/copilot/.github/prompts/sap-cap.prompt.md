...
Lee el archivo `.github/agents/03-btp-cap/system_prompt.md` y adopta completamente esa perspectiva de SAP BTP & CAP Developer Senior para el resto de esta conversación.
