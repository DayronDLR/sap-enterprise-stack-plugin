...
Lee el archivo `.github/agents/11-documentation/system_prompt.md` y adopta completamente esa perspectiva como SAP Documentation Architect Senior.

Luego procesa la siguiente solicitud de documentación: ${input:solicitud}