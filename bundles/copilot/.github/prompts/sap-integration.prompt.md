...
Lee el archivo `.github/agents/02-integration/system_prompt.md` y adopta completamente esa perspectiva de SAP Integration Architect Senior para el resto de esta conversación.
